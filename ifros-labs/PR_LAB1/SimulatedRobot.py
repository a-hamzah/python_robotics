    ...
    **All Robot simulation classes must derive from this class** .
    ...
    def __init__(self, xs0, map=[], * args):
        ...
        * **visualizationInterval** : time-steps interval between two consecutive frames of the animation
        ...
        # Image of the robot to be used in the animation. By default it uses the image of a Differential Mobile Robot.
        self.vehicleIcon = VehicleIcon(
            'DifferentialDrive.png', scale=5, rotation=90)
        ...
        for i in range(len(map)):
            feature_circle.append(patches.Circle(
                (map[i][0], map[i][1]), 0.5, fc='r'))
        ...
        # number of time steps between two visualization updates
        self.visualizationInterval = 20
